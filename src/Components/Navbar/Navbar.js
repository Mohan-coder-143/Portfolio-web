  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-[100] px-4 pt-4">
      <div className="bg-white shadow-lg rounded-xl w-full max-w-5xl mx-auto px-4 sm:px-6 py-3 flex justify-between items-center">
        ...
        {/* Mobile Hamburger */}
        <button 
          className="md:hidden text-2xl sm:text-3xl text-gray-800 flex-shrink-0 z-50" 
      ...
      {/* Mobile Menu Dropdown - Positioned below navbar container */}
      {open && (
        <div className="md:hidden fixed left-4 right-4 top-[72px] bg-white shadow-2xl rounded-xl z-40 animate-slideDown">
